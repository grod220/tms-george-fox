...
import PrincipleFeature from './principle-component/';
...
const TopIntro = () => (
  <Container>
    ...
    <BottomText>
      We do this by inviting all guests, from any background, to come and enjoy a meal with us. We want to share with
      you our philosophy of life and our heritage of Italian cooking. Every single dish is based on a recipe from our
      own famiglia. Whether it is our Nonna’s own traditional meatball---every dish is a story. Ask us!
    </BottomText>
  </Container>
);
