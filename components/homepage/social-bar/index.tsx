...
const SocialBar = () => (
  <Container>
    <TwoItemHolder>
      <LeftSide>
        <div>
          We are open <Highlight>Mon-Wed (3pm-9pm Takeout only)</Highlight>,{' '}
          <Highlight>Thurs-Sat (11am-9pm Dine in & Takeout)</Highlight>, and closed on Sundays. Come visit us!
        </div>
