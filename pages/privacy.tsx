...
export default function PrivacyPolicy() {
  return (
    <>
      <Head>
        <title>Privacy Policy :: The Meatball Stoppe</title>
      </Head>
      <ShortHero image={AboutUsHero} headline="Privacy policy" />
      <Container>
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to The Meatball Stoppe, accessible from{' '}
              <a href="https://themeatballstoppe.com/" rel="external nofollow noopener" target="_blank">
                https://themeatballstoppe.com/
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>By email: jeff@themeatballstoppe.com</li>
        </ul>
      </Container>
    </>
  );
